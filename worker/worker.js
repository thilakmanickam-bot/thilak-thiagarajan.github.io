...
export default {
  async fetch(request, env) {
    ...
    // Shared-token guard. Constant work regardless of match to avoid leaking
    // timing, and a plain equality check (tokens are high-entropy).
    ...
    // Forward Anthropic's response (status + JSON) back to the app verbatim.
