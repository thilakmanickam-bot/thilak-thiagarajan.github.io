...
data class PoruthamStrings(
    ...
    companion object {
        ...
        private val TE = PoruthamStrings(
            title = "వివాహ మ్యాచింగ్",
            entry = "వివాహ మ్యాచింగ్",
            subtitle = "ఉత్తమ జోడీ కోసం జ్యోతిష అనుకూలతను తనిఖీ చేయండి",
            boyDetails = "వరుడి వివరాలు",
            girlDetails = "వధువు వివరాలు",
            name = "పేరు",
            enterBoyName = "వరుడి పేరు నమోదు చేయండి",
            enterGirlName = "వధువు పేరు నమోదు చేయండి",
            rasi = "రాశి",
            nakshatram = "నక్షత్రం",
            calculate = "మ్యాచ్ లెక్కించు",
            boyName = "వరుడి పేరు",
            girlName = "వధువు పేరు",
            ...
            present = "ఉంది",
            absent = "లేదు",
            expertConnect = "నిపుణుడిని సంప్రదించండి",
            ...
            summaryFair = "అనుకూలత మరియు దీర్ఘాయువు విశ్లేషించబడ్డాయి. కొన్ని అంశాలను పరిగణించవలసిన ఓ మోస్తరు మ్యాచ్.",
        ...
        private val KN = PoruthamStrings(
            ...
            name = "ಹೆಸರು",
            enterBoyName = "ವರನ ಹೆಸರು ನಮೂದಿಸಿ",
            enterGirlName = "ವಧುವಿನ ಹೆಸರು ನಮೂದಿಸಿ",
            rasi = "ರಾಶಿ",
            nakshatram = "ನಕ್ಷತ್ರ",
            calculate = "ಹೊಂದಾಣಿಕೆ ಲೆಕ್ಕಿಸಿ",
            boyName = "ವರನ ಹೆಸರು",
            girlName = "ವಧುವಿನ ಹೆಸರು",
            ...
            present = "ಇದೆ",
            absent = "ಇಲ್ಲ",
            expertConnect = "ತಜ್ಞರನ್ನು ಸಂಪರ್ಕಿಸಿ",
        ...
        private val ML = PoruthamStrings(
            ...
            name = "പേര്",
            enterBoyName = "വരന്റെ പേര് നൽകുക",
            enterGirlName = "വധുവിന്റെ പേര് നൽകുക",
            rasi = "രാശി",
            nakshatram = "നക്ഷത്രം",
            calculate = "പൊരുത്തം കണക്കാക്കുക",
            boyName = "വരന്റെ പേര്",
            girlName = "വധുവിന്റെ പേര്",
            ...
            present = "ഉണ്ട്",
            absent = "ഇല്ല",
            expertConnect = "വിദഗ്ധനെ ബന്ധപ്പെടുക",
        ...
        private val MR = PoruthamStrings(
            ...
            boyDetails = "वराचे तपशील",
            girlDetails = "वधूचे तपशील",
            name = "नाव",
            enterBoyName = "वराचे नाव भरा",
            enterGirlName = "वधूचे नाव भरा",
            rasi = "राशी",
            nakshatram = "नक्षत्र",
            ...
            present = "आहे",
            absent = "नाही",
            expertConnect = "तज्ज्ञाशी संपर्क साधा",
