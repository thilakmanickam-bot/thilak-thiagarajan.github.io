...
data class PoruthamStrings(
    ...
    val birthDetails: String,
    val birthDetailsHint: String,
    val clearBirthDetails: String,
    val derivedFromBirth: String,
    ...
    companion object {
        ...
        private val EN = PoruthamStrings(
            ...
            birthDetailsHint = "Enter these and the rasi and nakshatram are worked out for you.",
            clearBirthDetails = "Clear birth details",
            derivedFromBirth = "Worked out from the birth details",
        ...
        private val HI = PoruthamStrings(
            ...
            birthDetailsHint = "ये भरें और राशि तथा नक्षत्र स्वतः निकल आएँगे।",
            clearBirthDetails = "जन्म विवरण हटाएँ",
            derivedFromBirth = "जन्म विवरण से निकाला गया",
        ...
        private val TE = PoruthamStrings(
            ...
            rasi = "రాశి",
            nakshatram = "నక్షత్రం",
            birthDetails = "జనన వివరాలు (ఐచ్ఛికం)",
            birthDetailsHint = "వీటిని నమోదు చేస్తే రాశి, నక్షత్రం వాటంతట అవే వస్తాయి.",
            clearBirthDetails = "జనన వివరాలను తొలగించండి",
            derivedFromBirth = "జనన వివరాల నుండి తీసినది",
        ...
        private val KN = PoruthamStrings(
            ...
            rasi = "ರಾಶಿ",
            nakshatram = "ನಕ್ಷತ್ರ",
            birthDetails = "ಜನನ ವಿವರಗಳು (ಐಚ್ಛಿಕ)",
            birthDetailsHint = "ಇವನ್ನು ನಮೂದಿಸಿದರೆ ರಾಶಿ ಮತ್ತು ನಕ್ಷತ್ರ ತಾನಾಗಿಯೇ ಬರುತ್ತದೆ.",
            clearBirthDetails = "ಜನನ ವಿವರಗಳನ್ನು ತೆಗೆದುಹಾಕಿ",
            derivedFromBirth = "ಜನನ ವಿವರಗಳಿಂದ ಪಡೆದದ್ದು",
        ...
        private val ML = PoruthamStrings(
            ...
            rasi = "രാശി",
            nakshatram = "നക്ഷത്രം",
            birthDetails = "ജനന വിവരങ്ങൾ (ഐച്ഛികം)",
            birthDetailsHint = "ഇവ നൽകിയാൽ രാശിയും നക്ഷത്രവും തനിയേ ലഭിക്കും.",
            clearBirthDetails = "ജനന വിവരങ്ങൾ മായ്ക്കുക",
            derivedFromBirth = "ജനന വിവരങ്ങളിൽ നിന്ന് കണക്കാക്കിയത്",
        ...
        private val MR = PoruthamStrings(
            ...
            rasi = "राशी",
            nakshatram = "नक्षत्र",
            birthDetails = "जन्म तपशील (ऐच्छिक)",
            birthDetailsHint = "हे भरल्यास राशी आणि नक्षत्र आपोआप निघते.",
            clearBirthDetails = "जन्म तपशील काढा",
            derivedFromBirth = "जन्म तपशिलावरून काढलेले",
        ...
        private val TA = PoruthamStrings(
            ...
            birthDetails = "பிறப்பு விவரங்கள் (விருப்பம்)",
            birthDetailsHint = "இவற்றை நிரப்பினால் ராசியும் நட்சத்திரமும் தானாகவே கிடைக்கும்.",
            clearBirthDetails = "பிறப்பு விவரங்களை நீக்கு",
            derivedFromBirth = "பிறப்பு விவரங்களிலிருந்து கணக்கிடப்பட்டது",
        ...
        private val ZH = PoruthamStrings(
            ...
            rasi = "月亮星座",
            nakshatram = "出生星宿",
            birthDetails = "出生信息（选填）",
            birthDetailsHint = "填写后将自动算出月亮星座与出生星宿。",
            clearBirthDetails = "清除出生信息",
            derivedFromBirth = "根据出生信息算出",
            calculate = "计算契合度",
            groomName = "男方姓名",
            brideName = "女方姓名",
            totalScore = "综合契合分数",
