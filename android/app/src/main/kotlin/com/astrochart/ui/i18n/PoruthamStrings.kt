...
data class PoruthamStrings(
    ...
    val saveMatch: String,
    val matchSaved: String,
    val savedMatches: String,
    val noSavedMatches: String,
    val deleteMatchConfirm: String,
    val fillAll: String,
    ...
    companion object {
        ...
        private val EN = PoruthamStrings(
            ...
            saveMatch = "Save this match",
            matchSaved = "Saved",
            savedMatches = "Saved Matches",
            noSavedMatches = "You haven't saved a match yet.",
            deleteMatchConfirm = "Delete this saved match?",
        ...
        private val HI = PoruthamStrings(
            ...
            saveMatch = "यह मिलान सहेजें",
            matchSaved = "सहेजा गया",
            savedMatches = "सहेजे गए मिलान",
            noSavedMatches = "अभी तक कोई मिलान सहेजा नहीं गया।",
            deleteMatchConfirm = "यह सहेजा गया मिलान हटाएँ?",
        ...
        private val TE = PoruthamStrings(
            ...
            saveMatch = "ఈ పొంతనను భద్రపరచండి",
            matchSaved = "భద్రపరచబడింది",
            savedMatches = "భద్రపరచిన పొంతనలు",
            noSavedMatches = "ఇంకా ఏ పొంతనా భద్రపరచలేదు.",
            deleteMatchConfirm = "ఈ పొంతనను తొలగించాలా?",
        ...
        private val KN = PoruthamStrings(
            ...
            saveMatch = "ಈ ಹೊಂದಾಣಿಕೆಯನ್ನು ಉಳಿಸಿ",
            matchSaved = "ಉಳಿಸಲಾಗಿದೆ",
            savedMatches = "ಉಳಿಸಿದ ಹೊಂದಾಣಿಕೆಗಳು",
            noSavedMatches = "ಇನ್ನೂ ಯಾವುದೇ ಹೊಂದಾಣಿಕೆ ಉಳಿಸಿಲ್ಲ.",
            deleteMatchConfirm = "ಈ ಹೊಂದಾಣಿಕೆಯನ್ನು ಅಳಿಸಬೇಕೆ?",
        ...
        private val ML = PoruthamStrings(
            ...
            saveMatch = "ഈ പൊരുത്തം സൂക്ഷിക്കുക",
            matchSaved = "സൂക്ഷിച്ചു",
            savedMatches = "സൂക്ഷിച്ച പൊരുത്തങ്ങൾ",
            noSavedMatches = "ഇതുവരെ ഒരു പൊരുത്തവും സൂക്ഷിച്ചിട്ടില്ല.",
            deleteMatchConfirm = "ഈ പൊരുത്തം ഇല്ലാതാക്കണോ?",
        ...
        private val MR = PoruthamStrings(
            ...
            saveMatch = "ही जुळणी जतन करा",
            matchSaved = "जतन केले",
            savedMatches = "जतन केलेल्या जुळण्या",
            noSavedMatches = "अद्याप कोणतीही जुळणी जतन केलेली नाही.",
            deleteMatchConfirm = "ही जतन केलेली जुळणी हटवायची?",
        ...
        private val TA = PoruthamStrings(
            ...
            saveMatch = "இந்தப் பொருத்தத்தைச் சேமி",
            matchSaved = "சேமிக்கப்பட்டது",
            savedMatches = "சேமித்த பொருத்தங்கள்",
            noSavedMatches = "இதுவரை எந்தப் பொருத்தமும் சேமிக்கப்படவில்லை.",
            deleteMatchConfirm = "இந்தப் பொருத்தத்தை நீக்கவா?",
        ...
        private val ZH = PoruthamStrings(
            ...
            matchSaved = "已保存",
            savedMatches = "已保存的合婚",
            noSavedMatches = "还没有保存任何合婚。",
            deleteMatchConfirm = "确定删除这条已保存的合婚？",
