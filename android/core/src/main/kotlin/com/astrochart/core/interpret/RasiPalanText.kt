...
object RasiPalanText {
    ...
    private fun work(lang: Language): List<String> = when (lang.content) {
        ContentLang.EN -> listOf(
    ...
    private fun love(lang: Language): List<String> = when (lang.content) {
        ContentLang.EN -> listOf(
